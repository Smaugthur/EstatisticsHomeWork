...
namespace OUTPUT
{
    class OutputMethods
    {
        public static void printTable(StatisticsSimple Data)
        {
            ...
            {
                Console.WriteLine($"|{Data.frecuencyValues[i],-15}|{Data.absoluteFrecuency[i],-15}|{Data.cumulativeFrecuency[i],-15}|{Data.relativeFrecuency[i], +15:F3}|");
            }
        ...
        public static void printTable(StatisticsWithIntervals Data)
        {
            ...
            {
                Console.WriteLine($"|{Data.frecuencyValues[i,0] + " - " + Data.frecuencyValues[i,1],-15}|{Data.absoluteFrecuency[i],-15}|{Data.cumulativeFrecuency[i],-15}|{Data.relativeFrecuency[i], +15:F3}|");
            }
            Console.WriteLine($"|{"TOTAL",15}|{Data.inputData.Length,15}|{"",15}|\n");
        }
    }
